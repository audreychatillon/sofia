...
void SOFIAoffline_s444()
{
    ...
    TString filename = "/media/audrey/COURGE/SOFIA/ANALYSE/SOFIA3/data/202002_eng/main0124_0001.lmd";

    // Output file ------------------------------------------
    TString outputFileName = "data_s444_main0124.root";
    ...
    // Calibration files ------------------------------------
    TString dir = "/media/audrey/COURGE/R3BSof/R3BRoot";
